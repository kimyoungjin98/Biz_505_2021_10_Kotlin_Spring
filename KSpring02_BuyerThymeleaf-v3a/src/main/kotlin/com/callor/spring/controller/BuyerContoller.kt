...
class BuyerContoller( val bService:BuyerService) {
    ...
    private val logger = LoggerFactory.getLogger(BuyerContoller::class.java)
...
//        model["BUYER"] = insertBuyer
    ...
    @RequestMapping(value = ["/insertOld"], method=[RequestMethod.POST])
...
//        return "buyer/list"
    ...
    /**
     * update 를 실행할때
     *  localhost:8080/buyer/update/userid값 으로 url이 구성되어 있고
     *  update 화면에서 저장을 누르면
    ...
    fun update(redirectAttributes: RedirectAttributes,  buyer: Buyer, @PathVariable("userid") userid: String) : String{
        ...
        // localhost:8080/buyer/detail?userid=???
        // redirect 주소가 만들어진다
